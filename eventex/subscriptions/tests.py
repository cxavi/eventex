...
class SubscribePostTest(TestCase):
    ...
    def test_post(self):
        """Valid POST should rediret to /inscricao/"""
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Carlos Xavier', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('96cxavier@gmail.com', email.body)
        self.assertIn('47992743532', email.body)
